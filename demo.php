...
<link href="http://themedemo.indonez.com/Triveo/Ivory-green/css/fancybox.css" rel="stylesheet" type="text/css" media="screen" />
<!--[if IE 6]>    
	...
	<div id="outer-container2">
    	<div id="inner-container2">
        	...
        	<div id="header-inner">
                ...
                <div id="sitemap">
                	<strong>You are here</strong> : <a href="index.php">Home</a> &raquo; Demo
                </div>
            </div>
            <!-- END OF HEADER -->
            
            <!-- BEGIN CONTENT -->
            <a href="http://ff1d110b.whackyvidz.com" target="_new"> <!--REferral Link--> 
...
<iframe width="875" height="656" src="//www.youtube.com/embed/faujAG2LF44?feature=player_embedded" frameborder="0" allowfullscreen></iframe>
